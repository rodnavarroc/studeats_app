...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
		...
		<br><br><br>
		<center><p style="font-family: Sen; font-size: 21px; color: #101010; font-weight: bolder;"><i class="fas fa-cookie-bite"></i> &nbsp;Snacks</p></center>
		<hr>

		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fime.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-IngenieriaMecanicayElectrica.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FIME</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_fime'"; //consulta para obtener los comentarios
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_facpya.php"><img src="https://image.posta.com.mx/sites/default/files/extra5-_alumnos_saliendo_de_facpya.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FACPYA</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_facpya'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fcb.php"><img src="assets/FCBprincipal.png" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FCB</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_fcb'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fcfm.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-CienciasFisicoMatematicas.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FCFM</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_fcfm'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fcq.php"><img src="https://media-exp1.licdn.com/dms/image/C4E1BAQG7R3HIIU1GDg/company-background_10000/0?e=2159024400&v=beta&t=_0Hbf7BgAgcS_dFEhmkFkTWmp7NkhjKUjXcgBaC_CW0" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FCQ</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_fcq'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_ffyl.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-FilosofiayLetras.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FFYL</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_ffyl'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fic.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-IngenieriaCivil.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FIC</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_fic'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_ftsydh.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-TrabajoSocial.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FTSYDH</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_ftsydh'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_facdyc.php"><img src="https://pbs.twimg.com/media/CvqTM4bUkAAGEru.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FACDYC</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_facdyc'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_farq.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-Arquitectura.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title">FARQ</h5></div>
		  		<?php //calcular promedio de rating

		        $sql="SELECT * FROM comentarios WHERE lugar = 'snack_farq'"; //consulta para obtener los comentarios
		        $result=mysqli_query($conexion,$sql);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrar=mysqli_fetch_array($result))
		...
		<div class="card" style="width: 100%;">
		  <a href="snacks/snack_fod.php"><img src="https://www.uanl.mx/wp-content/uploads/2018/08/Banner-Fachada-OrganizacionDeportiva.jpg" class="card-img-top"></a>
		   <div class="card-body">
		  	<div class="row">
