...
<div class="container" style="overflow: hidden; position: fixed; top: 0; width: 100%; z-index: 10; background-color: #f2f2f2;" id="barraSuperior">
	<div class="row">
		...
		<div class="col-6">
		<a href="../listado_restaurantes.php" style="display: block; text-decoration: none; font-family: Roboto; font-size: 16px; color: #101010; padding-top: 8%; text-align: right;"><i class="fas fa-chevron-left"></i> &nbsp;Regresar</a><br>
		</div>
	</div>
</div>
...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;">I Like Pizza</h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/s960x960/88253801_3697049556979413_8378072088740626432_o.jpg?_nc_cat=107&_nc_sid=8024bb&_nc_oc=AQkvFnQXUe5MTbE00mSzug-yLet719fyOp1ZeIgIKo1jA3G2preY5Io0wtcNJTvD1no&_nc_ht=scontent.fntr3-1.fna&_nc_tp=7&oh=cebb062ee473a3821a6154b8ce636dcc&oe=5EC37C52">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/s960x960/87734572_3680263141991388_1250156854063923200_o.jpg?_nc_cat=110&_nc_sid=8024bb&_nc_oc=AQncg4vfWouoEK1lcJauGdhg5TNuB2gMaOCQ2VOsAy-074sh_Yf1At-asqf5AjxTUd0&_nc_ht=scontent.fntr3-1.fna&_nc_tp=7&oh=b0291486f4f86c953882d0fb454c7319&oe=5EC1DB79">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/s960x960/87028621_3651766014841101_3071665674142089216_o.jpg?_nc_cat=100&_nc_sid=8024bb&_nc_oc=AQlUnYcO6mA1UPzXfENr_UagqrM7VEB_zZizS_R-chBYdOEzrVzubPwcegd6zSM_9dI&_nc_ht=scontent.fntr3-1.fna&_nc_tp=7&oh=341db0a084cf651384d97a21c86090b9&oe=5EC27C1B">
	        </div>
	    </div>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	        <iframe id="pdfviewer" src="https://docs.google.com/gview?embedded=true&url=http://studeats.000webhostapp.com/assets/menus/ilikepizza.pdf&amp;embedded=true" frameborder="0" style="width: 100%; height: 500px;"></iframe>
	      </div>
	    </div>
	  </div>
	</div>
