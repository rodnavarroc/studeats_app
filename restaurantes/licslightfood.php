...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;">LICS Lightfood</h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/76732961_149854823039511_3000117725218471936_o.jpg?_nc_cat=110&_nc_sid=dd9801&_nc_oc=AQmA-AI0aX3YUxhZDENOVDRrm_IVqj5KeMkPam9yq6DDpolgxsagTHE5o1yw39zp7CY&_nc_ht=scontent.fntr3-1.fna&oh=e4940a0f68da2e6e0396a58ec718bd7c&oe=5EC29B16">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/88099073_198020244889635_3180406081343979520_o.jpg?_nc_cat=109&_nc_sid=8024bb&_nc_oc=AQk1kQyrUnGRf1gDHUXuUNnTyhVB_LWCKPbhd5YNSzkpJuKdbiu4fPC4G7VYCTlnxTI&_nc_ht=scontent.fntr3-1.fna&oh=177a9079f42cf9efc7d0830f45539bf7&oe=5EC48306">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/87988657_198019521556374_2174144391201947648_o.jpg?_nc_cat=107&_nc_sid=8024bb&_nc_oc=AQmMzaNULk-NMlCO3f_BZmvy1DtXamwudBOl7SkyWOE-rLpUztuExl3LPs15xKoWE1o&_nc_ht=scontent.fntr3-1.fna&oh=c9070a3b5310153b871e0f84e7ea0349&oe=5EC25D77">
	        </div>
	    </div>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	        <iframe id="pdfviewer" src="https://docs.google.com/gview?embedded=true&url=http://studeats.000webhostapp.com/assets/menus/lics.pdf&amp;embedded=true" frameborder="0" style="width: 100%; height: 500px;"></iframe>
	      </div>
	    </div>
	  </div>
	</div>
