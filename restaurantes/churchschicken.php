...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;">Church's Chicken</h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://static-images.ifood.com.br/image/upload/f_auto,t_high/capa/571d92ca-c44a-40ab-baec-bea214be6ea6/201906201833_gOvz_d@2x.jpg">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://www.churchs.com.mx/test/media/catalog/product/cache/37/thumbnail/600x/17f82f742ffe127f42dca9de82fb58b1/p/a/pagina_web_ch_nueva_ind._4_fajitas_1.jpg">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://churchchikentorreon.com/img/3264/662.jpg">
	        </div>
	    </div>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	        <iframe id="pdfviewer" src="https://docs.google.com/gview?embedded=true&url=http://studeats.000webhostapp.com/assets/menus/churchschicken.pdf&amp;embedded=true" frameborder="0" style="width: 100%; height: 500px;"></iframe>
	      </div>
	    </div>
	  </div>
	</div>
