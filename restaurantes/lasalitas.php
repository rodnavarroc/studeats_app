...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;">Las Alitas</h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://media-cdn.tripadvisor.com/media/photo-s/12/f9/93/08/nunca-he-venido.jpg">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t31.0-8/17636904_10154948778536047_5870924080569074241_o.jpg?_nc_cat=100&_nc_sid=2d5d41&_nc_oc=AQn9BNagI-0v5VR0U2N5H3TfrGKfHfZPHpxx9CKgXWauOeMoCZbzt8WqO8LbYN9JxgA&_nc_ht=scontent.fntr3-1.fna&oh=f9998b0e83bcd3b7c468eb97c8f2e9cd&oe=5EC18F03">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://scontent.fntr3-1.fna.fbcdn.net/v/t1.0-9/17308941_10154908021156047_149893535573890873_n.jpg?_nc_cat=103&_nc_sid=2d5d41&_nc_oc=AQnMmhG_su83m4EeqeT7V5xVDu-24oVZWSPY0kx3PoVXf15cnohOr-CjD3xmy1bp3XE&_nc_ht=scontent.fntr3-1.fna&oh=9c9fd8aee4500663064c74449762f7a3&oe=5EC20821">
	        </div>
	    </div>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	        <iframe id="pdfviewer" src="https://docs.google.com/gview?embedded=true&url=http://studeats.000webhostapp.com/assets/menus/lasalitas.pdf&amp;embedded=true" frameborder="0" style="width: 100%; height: 500px;"></iframe>
	      </div>
	    </div>
	  </div>
	</div>
