...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;">Papa John's</h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://d1ralsognjng37.cloudfront.net/ab00edd2-3d11-4cbe-9017-8497f02c3822.jpeg">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://i.pinimg.com/originals/e2/d8/0a/e2d80ae6bf0290b5c37ac57baeb41533.jpg">
	        </div>
	        <div class="carousel-item" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="https://s3-media0.fl.yelpcdn.com/bphoto/4tjpOa5JBpimr2wPyVZnMw/o.jpg">
	        </div>
	    </div>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	        <iframe id="pdfviewer" src="https://docs.google.com/gview?embedded=true&url=http://studeats.000webhostapp.com/assets/menus/papajohns.pdf&amp;embedded=true" frameborder="0" style="width: 100%; height: 500px;"></iframe>
	      </div>
	    </div>
	  </div>
	</div>
