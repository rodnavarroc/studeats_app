...
$nomLugar = $_GET['ref'];
if(!isset($nomLugar)) header("Location: listado_negocios.php");
...
<div class="container" style="overflow: hidden; position: fixed; top: 0; width: 100%; z-index: 10; background-color: #f2f2f2;" id="barraSuperior">
	<div class="row">
		...
		<div class="col-6">
		<a href="listado_negocios.php" style="display: block; text-decoration: none; font-family: Roboto; font-size: 16px; color: #101010; padding-top: 8%; text-align: right;"><i class="fas fa-chevron-left"></i> &nbsp;Regresar</a><br>
		</div>
	</div>
</div>
...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
	...
	<?php
	$sql="SELECT * FROM negocios WHERE alias_negocio = '$nomLugar'";
    $result=mysqli_query($conexion,$sql);
    $mostrar=mysqli_fetch_array($result);
	?>

	<br><br><br>
	<center><h3 style="font-family: Sen; font-size: 24px; color: #fff; background-color: #1fb553; padding: 3% 3%;"><?php echo $mostrar['nombre_negocio'];?></h3></center><br>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="carousel-item active" style="height: 250px; overflow: hidden;">
	            <img class="d-block w-100" src="negocios/<?php echo $mostrar['alias_negocio'];?>/fotoSlider1.jpg">
	        </div>
	...
	<div style="font-family: Roboto; font-size: 15px; color: #101010;">
		...
		<table class="table" style="border: none;">
			<tr>
				...
				<td><?php echo $mostrar['rango_precios'];?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><a href="http://wa.me/52<?php echo $mostrar['telefono'];?>" style="color: darkblue;"><?php echo $mostrar['telefono'];?></a></td>
			</tr>
			<tr>
	  ...
	  <div class="card" style="background-color: transparent; border: 0;">
	    ...
	    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body" style="background-color: #fff;">
	      	...
	      	<table class="table">
	      	<thead class="thead-light" style="font-family: Sen;">
		    	<th><center>Producto</center></th>
		    	<th><center>Precio</center></th>
		    </thead>
		    <tbody>
		      	<?php 
			    $sql="SELECT * FROM productos_negocios WHERE nombre_negocio = '$nomLugar'"; //obtener los productos
			    $result=mysqli_query($conexion,$sql);
			    while($mostrar=mysqli_fetch_array($result)){
			    $division = explode("-", $mostrar['producto']); //dividir producto y precio
			    ?>
			    <tr>
			    	<td><center><?php echo $division[0];?></center></td>
			    	<td><center><?php echo $division[1];?></center></td>
			    </tr>
		        <?php } ?>
	    	</tbody>
	    	</table>
	    ...
	    $result=mysqli_query($conexion,$sql);
	    $mostrar=mysqli_fetch_array($result);
	    $query = str_replace(' ', '%20', $mostrar['ubicacion']); //reemplazar los espacios en la ubicacion para string de Google Maps
		?>

		<div class="container"><div class="gmap_canvas"><iframe width="100%;" id="gmap_canvas" src="https://maps.google.com/maps?q=<?php echo $query?>&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div><style>.mapouter{position:relative;text-align:right;height:200px;width:350px;}.gmap_canvas {overflow:hidden;background:none}</style></div>
