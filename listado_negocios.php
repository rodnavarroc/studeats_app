...
<div class="container" style="margin-top: 0px; z-index: 9;" id="main">
		...
		<br><br><br>
		<center><p style="font-family: Sen; font-size: 21px; color: #101010; font-weight: bolder;"><i class="fas fa-hands-helping"></i> &nbsp;Trade n' eat</p></center>
		<hr>

		<?php
		$sql="SELECT * FROM negocios"; //consulta para obtener los negocios
		$result=mysqli_query($conexion,$sql);
		while($mostrar=mysqli_fetch_array($result))
		{
		?>
		<div class="card" style="width: 100%;">
		  <a href="negocio.php?ref=<?php echo $mostrar['alias_negocio'];?>"><img src="negocios/<?php echo $mostrar['alias_negocio'];?>/fotoPrincipal.jpg" class="card-img-top"></a>
		  <div class="card-body">
		  	<div class="row">
		  		<div class="col-6"><h5 class="card-title"><?php echo $mostrar['nombre_negocio']; ?></h5></div>
		  		
		  		<?php //calcular promedio de rating
		  		$nomLugar = $mostrar['alias_negocio'];
		        $sqlx="SELECT * FROM comentarios WHERE lugar = '$nomLugar'"; //consulta para obtener los comentarios
		        $resultx=mysqli_query($conexion,$sqlx);
		        $conteo = 0;
		        $suma = 0;
		        while($mostrarx=mysqli_fetch_array($resultx))
		        {
		        $suma = $suma + $mostrarx['calificacion'];
		        $conteo++; 
		    	}
